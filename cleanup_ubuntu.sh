...
clean_wordpress_audit_logs() {
    ...
    echo -e "${YELLOW}⚠️  ВНИМАНИЕ: Удаление этих файлов может повлиять на работу сайтов!${NC}"
    echo -e "${YELLOW}Эти файлы содержат логи безопасности различных плагинов и систем.${NC}"
    echo ""
